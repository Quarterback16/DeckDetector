...
{ "Zola the Gorgon", new CardData { ManaCost = 3 } },
 ...
 {"Abusive Sergeant", new CardData { ManaCost = 0 } },
 {"Acornbearer", new CardData { ManaCost = 0 } },
 {"Ancestral Spirit", new CardData { ManaCost = 0 } },
 {"Ancient Watcher", new CardData { ManaCost = 0 } },
 {"Arcane Watcher", new CardData { ManaCost = 0 } },
 {"Archivist Elysiana", new CardData { ManaCost = 0 } },
 {"Archmage Vargoth", new CardData { ManaCost = 0 } },
 {"Arch-Villain Rafaam", new CardData { ManaCost = 0 } },
 {"Auchenai Phantasm", new CardData { ManaCost = 0 } },
 {"Auchenai Soulpriest", new CardData { ManaCost = 0 } },
 {"Baited Arrow", new CardData { ManaCost = 0 } },
 {"Big Bad Voodoo", new CardData { ManaCost = 0 } },
 {"Blastmaster Boom", new CardData { ManaCost = 0 } },
 {"Blessing of the Ancients", new CardData { ManaCost = 0 } },
 {"Bomb Toss", new CardData { ManaCost = 0 } },
 {"Book of Specters", new CardData { ManaCost = 0 } },
 {"Boommaster Flark", new CardData { ManaCost = 0 } },
 {"Bronze Gatekeeper", new CardData { ManaCost = 0 } },
 {"Bronze Herald", new CardData { ManaCost = 0 } },
 {"Cathedral Gargoyle", new CardData { ManaCost = 0 } },
 {"Catrina Muerte", new CardData { ManaCost = 0 } },
 {"Chameleos", new CardData { ManaCost = 0 } },
 {"Clockwork Goblin", new CardData { ManaCost = 0 } },
 {"Commander Rhyssa", new CardData { ManaCost = 0 } },
 {"Conjurer's Calling", new CardData { ManaCost = 0 } },
 {"Convincing Infiltrator", new CardData { ManaCost = 0 } },
 {"Crystalsong Portal", new CardData { ManaCost = 0 } },
 {"Dalaran Librarian", new CardData { ManaCost = 0 } },
 {"Desperate Measures", new CardData { ManaCost = 0 } },
 {"Dragon Roar", new CardData { ManaCost = 0 } },
 {"Dreamway Guardians", new CardData { ManaCost = 0 } },
 {"Eureka!", new CardData { ManaCost = 0 } },
 {"EVIL Cable Rat", new CardData { ManaCost = 0 } },
 {"EVIL Conscripter", new CardData { ManaCost = 0 } },
 {"EVIL Genius", new CardData { ManaCost = 0 } },
 {"EVIL Miscreant", new CardData { ManaCost = 0 } },
 {"Explodinator", new CardData { ManaCost = 0 } },
 {"Face Collector", new CardData { ManaCost = 0 } },
 {"Faceless Rager", new CardData { ManaCost = 0 } },
 {"Forbidden Words", new CardData { ManaCost = 0 } },
 {"Grimscale Oracle", new CardData { ManaCost = 0 } },
 {"Hagatha's Scheme", new CardData { ManaCost = 0 } },
 {"Hecklebot", new CardData { ManaCost = 0 } },
 {"Heistbaron Togwaggle", new CardData { ManaCost = 0 } },
 {"Hench-Clan Burglar", new CardData { ManaCost = 0 } },
 {"Hench-Clan Hogsteed", new CardData { ManaCost = 0 } },
 {"Hench-Clan Shadequill", new CardData { ManaCost = 0 } },
 {"Hidden Wisdom", new CardData { ManaCost = 0 } },
 {"Holy Nova", new CardData { ManaCost = 0 } },
 {"Jepetto Joybuzz", new CardData { ManaCost = 0 } },
 {"Keeper Stalladris", new CardData { ManaCost = 0 } },
 {"Khadgar", new CardData { ManaCost = 0 } },
 {"Madame Lazul", new CardData { ManaCost = 0 } },
 {"Magic Carpet", new CardData { ManaCost = 0 } },
 {"Mark of the Loa", new CardData { ManaCost = 0 } },
 {"Marked Shot", new CardData { ManaCost = 0 } },
 {"Mass Resurrection", new CardData { ManaCost = 0 } },
 {"Missile Launcher", new CardData { ManaCost = 0 } },
 {"Muckmorpher", new CardData { ManaCost = 0 } },
 {"Murloc Tastyfin", new CardData { ManaCost = 0 } },
 {"Murloc Tidehunter", new CardData { ManaCost = 0 } },
 {"Mysterious Blade", new CardData { ManaCost = 0 } },
 {"Never Surrender!", new CardData { ManaCost = 0 } },
 {"Omega Devastator", new CardData { ManaCost = 0 } },
 {"Onyxia", new CardData { ManaCost = 0 } },
 {"Pilfer", new CardData { ManaCost = 0 } },
 {"Power of Creation", new CardData { ManaCost = 0 } },
 {"Quartz Elemental", new CardData { ManaCost = 0 } },
 {"Rabble Bouncer", new CardData { ManaCost = 0 } },
 {"Rapid Fire", new CardData { ManaCost = 0 } },
 {"Replicating Menace", new CardData { ManaCost = 0 } },
 {"Scargil", new CardData { ManaCost = 0 } },
 {"Shadow Word: Pain", new CardData { ManaCost = 0 } },
 {"Shimmerfly", new CardData { ManaCost = 0 } },
 {"Sludge Slurper", new CardData { ManaCost = 0 } },
 {"Soul of the Murloc", new CardData { ManaCost = 0 } },
 {"Spectral Cutlass", new CardData { ManaCost = 0 } },
 {"Sunreaver Spy", new CardData { ManaCost = 0 } },
 {"Tess Greymane", new CardData { ManaCost = 0 } },
 {"The Forest's Aid", new CardData { ManaCost = 0 } },
 {"Thoughtsteal", new CardData { ManaCost = 0 } },
 {"Toxfin", new CardData { ManaCost = 0 } },
 {"Underbelly Angler", new CardData { ManaCost = 0 } },
 {"Underbelly Fence", new CardData { ManaCost = 0 } },
 {"Unleash the Beast", new CardData { ManaCost = 0 } },
 {"Unseen Saboteur", new CardData { ManaCost = 0 } },
 {"Unsleeping Soul", new CardData { ManaCost = 0 } },
 {"Ursatron", new CardData { ManaCost = 0 } },
 {"Vendetta", new CardData { ManaCost = 0 } },
 {"Venomizer", new CardData { ManaCost = 0 } },
 {"Vereesa Windrunner", new CardData { ManaCost = 0 } },
 {"Waggle Pick", new CardData { ManaCost = 0 } },
 {"Walk the Plank", new CardData { ManaCost = 0 } },
 {"Walking Fountain", new CardData { ManaCost = 0 } },
 {"Wrenchcalibur", new CardData { ManaCost = 0 } },
